        ...
        <ul className="data-visual-list">
          <li>
            <div className="data-visual-text-container">
              ...
              <p>
                This shows the distribution of article headline lengths by word
                count. Fake news articles tend to have longer titles to pack in
                more dramatic or eye-catching words.
              </p>
            </div>
          ...
          <li>
            <div className="data-visual-text-container">
              <h2 className="h3">Strip Plot | Headline Clickbait Analysis</h2>
              <p>
                This visualizes the clickbait score of article headlines based
                on certain linguistic features like excessive punctuation or
                capitalized words. Fake news articles tend to use more
          ...
          <li>
            <div className="data-visual-text-container">
              <h2 className="h3">Density Plot | Lexical Diversity</h2>
              <p>
