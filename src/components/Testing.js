        ...
        <>
            ...
            <div className="data-container">
                ...
                <p className="testing-page-content">
                    The neural network model underwent automated testing in the
                    training environment prior to integration with the web
                    service. Of the 45,000 articles in the data set, 25% were
                    partitioned into a separate testing set. Keras was used to
                    batch test this set after training, and the model achieved{" "}
                    <strong>98% accuracy</strong>.
                </p>
                <h2 className="h3">Post-Integration Testing</h2>
                <p className="testing-page-content">
                    After integrating the model into the web service, random
                    news articles found online were used to conduct additional
                    manual testing to better compare model accuracy against
                    newer, non-curated data.
                </p>
                <h2 className="h3">Results</h2>
                <p className="testing-page-content">
                    The model tends to do well with articles centered around
                    politics and world events, but it isn't as performant with
                    other topics. This suggests the training set was biased
                    towards the aforementioned subjects.
                </p>
                <p>
                    A few articles and their prediction results are listed below
                        ...
                        <tr className="prediction-success">
                            <td>
                                <a
                                    ...
                                    rel="noreferrer"
                                >
                                    Trump defends foreign worker visas, siding
                                    with Musk amid MAGA backlash
                                </a>
                            </td>
                            <td>Politics</td>
                            <td>Real</td>
                        ...
                        <tr className="prediction-success">
                            <td>
                                <a
                                    ...
                                    rel="noreferrer"
                                >
                                    SEE IT: China stuns with maiden flight of
                        ...
                        <tr className="prediction-success">
                            <td>
                                <a
                                    ...
                                    rel="noreferrer"
                                >
                                    Zelensky Calls On U.S. To Send Totally
                                    Psycho Marine
                                </a>
                            </td>
                            <td>World News</td>
                        ...
                        <tr className="prediction-success">
                            <td>
                                <a
                                    ...
                                    rel="noreferrer"
                                >
                                    What to know about the Blake Lively and
                        ...
                        <tr className="prediction-fail">
                            <td>
                                <a
                                    ...
                                    rel="noreferrer"
                                >
                                    What the Bob Dylan Biopic 'A Complete
                                    Unknown' Gets Wrong
                                </a>
                            </td>
                            <td>Film & Music</td>
                        ...
                        <tr className="prediction-fail">
                            <td>
                                <a
                                    ...
                                    rel="noreferrer"
                                >
                                    Cosby Show actor Geoffrey Owens reveals he
                                    still struggles to make ends meet after
                                    viral Trader Joe's moment
                                </a>
                            </td>
                            <td>Celebrity Culture</td>
                            <td>Real</td>
